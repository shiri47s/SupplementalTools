...
public final class ModWorldGenProvider extends FabricDynamicRegistryProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registries, Entries entries) {
        entries.add(registries.getOrThrow(Registries.CONFIGURED_FEATURE), ModConfiguredFeatures.LEAD_ORE);
        entries.add(registries.getOrThrow(Registries.PLACED_FEATURE), ModPlacedFeatures.LEAD_ORE_LOWER);

        entries.add(registries.getOrThrow(Registries.CONFIGURED_FEATURE), ModConfiguredFeatures.RED_DIAMOND_ORE);
        entries.add(registries.getOrThrow(Registries.PLACED_FEATURE), ModPlacedFeatures.RED_DIAMOND_ORE_LOWER);
        entries.add(registries.getOrThrow(Registries.PLACED_FEATURE), ModPlacedFeatures.RED_DIAMOND_ORE_UPPER);

        entries.add(registries.getOrThrow(Registries.CONFIGURED_FEATURE), ModConfiguredFeatures.DEEPSLATE_RED_DIAMOND_ORE);
        entries.add(registries.getOrThrow(Registries.PLACED_FEATURE), ModPlacedFeatures.DEEPSLATE_RED_DIAMOND_ORE_LOWER);
    }

    public static void configuredFeature(Registerable<ConfiguredFeature<?, ?>> registerable) {
        ConfiguredFeatures.register(registerable, ModConfiguredFeatures.LEAD_ORE, Feature.ORE, new OreFeatureConfig(new TagMatchRuleTest(BlockTags.STONE_ORE_REPLACEABLES), ModBlocks.LEAD_ORE.get().defaultBlockState(), 12));
        ConfiguredFeatures.register(registerable, ModConfiguredFeatures.RED_DIAMOND_ORE, Feature.ORE, new OreFeatureConfig(new TagMatchRuleTest(BlockTags.STONE_ORE_REPLACEABLES), ModBlocks.RED_DIAMOND_ORE.get().defaultBlockState(), 5, 0.3F));
        ConfiguredFeatures.register(registerable, ModConfiguredFeatures.DEEPSLATE_RED_DIAMOND_ORE, Feature.ORE, new OreFeatureConfig(new TagMatchRuleTest(BlockTags.DEEPSLATE_ORE_REPLACEABLES), ModBlocks.DEEPSLATE_RED_DIAMOND_ORE.get().defaultBlockState(), 5, 0.77F));
    }
