...
public class BronzeArmorItem extends ModArmorItem {
    public BronzeArmorItem(ArmorType type, Item.Properties settings) {
        super(ModArmorMaterials.BRONZE, type, settings.rarity(Rarity.UNCOMMON).durability(type.getDurability(12)));
    }
    ...
    protected void appendFullSetsTooltip(ItemStack stack, Item.TooltipContext context, Consumer<Component> textConsumer) {
        textConsumer.accept(Component.translatable("item.sptools.blessing.copper").withStyle(ChatFormatting.GREEN));
    }
}
