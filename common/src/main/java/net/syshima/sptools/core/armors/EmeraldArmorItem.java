...
public class EmeraldArmorItem extends ModArmorItem {
    ...
    public EmeraldArmorItem(EquipmentType type, Item.Settings settings) {
        super(ModArmorMaterials.EMERALD, type, settings.rarity(Rarity.RARE).maxDamage(type.getMaxDamage(21)));
    }
    ...
    protected void appendFullSetsTooltip(ItemStack stack, TooltipContext context, Consumer<Text> textConsumer) {
        textConsumer.accept(Text.translatable("item.sptools.blessing.emerald").formatted(Formatting.GREEN));
    }
}
