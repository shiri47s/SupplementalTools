...
public class ArmorItemModelGenerator {
    ...
    private static void generateItems() {
        ...
        ARMOR_REGISTER.register(Constants.Item.QUARTZ_INGOT, () -> new Item(new Item.Settings()));
        ARMOR_REGISTER.register(Constants.Item.QUARTZ_SCRAP, () -> new Item(new Item.Settings()));
        ARMOR_REGISTER.register(Constants.Item.REDSTONE_INGOT, () -> new Item(new Item.Settings()));
    }
}
