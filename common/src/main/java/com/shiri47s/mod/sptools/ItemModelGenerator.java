...
public class ItemModelGenerator {
    ...
    private static void generateItems() {
        ...
        ITEM_REGISTER.register(Constants.Item.QUARTZ_INGOT, () -> new QuartzIngot(new Item.Settings()));
        ITEM_REGISTER.register(Constants.Item.QUARTZ_SCRAP, () -> new SupplementalToolsItem(new Item.Settings()));
        ITEM_REGISTER.register(Constants.Item.REDSTONE_INGOT, () -> new RedstoneIngot(new Item.Settings()));
